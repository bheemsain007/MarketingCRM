    ...
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              // `is_overdue` comes from the server, which evaluated it against
              // its own clock. This app renders the flag; it never derives it.
              StatusChip(
                label: followUp.isOverdue ? 'Overdue' : followUp.statusLabel,
                tone: followUp.isOverdue ? ChipTone.danger : ChipTone.neutral,
              ),
